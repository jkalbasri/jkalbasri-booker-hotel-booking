  ...
  return (
    <>
          ...
          >
            ...
            <div className="items-center">
              <div>
                <button
                  type="submit"
                  className="bg-brand-secondary hover:bg-slate-100 hover:text-brand-secondary text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full"
                >
                  Log In
                </button>
              </div>
              ...
              <div className="flex flex-wrap justify-center my-3 w-full mt-12">
                <Link
                  to="/register"
                  className="inline-block align-baseline font-medium text-md text-slate-600 hover:text-blue-800 text-right"
                >
                  Create an account
                </Link>
              </div>
      ...
      <div className="bg-slate-50 flex flex-col mx-auto w-full max-w-lg px-4">
        <p className="text-slate-600 font-medium text-md">Test user details</p>
        <p className="text-slate-600 text-md">Email: user1@example.com</p>
        <p className="text-slate-600 text-md">Password: password1</p>
      </div>
    </>
  );
};
