              ...
              <Form>
                <div className="w-full max-w-lg p-4 shadow-md md:p-10">
                  <div className="mb-10 text-center">
                    <h2 className="text-3xl font-extrabold text-slate-600 py-2">
                      Join the Adventure!
                    </h2>
                  ...
                  <div className="flex items-center w-full my-3">
                    <button
                      type="submit"
                      className="w-full px-4 py-2 font-bold bg-brand-secondary hover:bg-slate-100 hover:text-brand-secondary text-white focus:outline-none focus:shadow-outline"
                    >
                      Register
                    </button>
                  </div>
