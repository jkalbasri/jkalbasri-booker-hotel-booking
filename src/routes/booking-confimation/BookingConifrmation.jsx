  ...
  return (
    <div className="md:mx-auto max-w-[800px] my-40">
      <div className="flex justify-between mx-2 rounded-md my-2">
        <Link
          to="/"
          className={`border p-2 min-w-[120px] text-center transition-all delay-100 hover:bg-brand hover:text-brand-secondary`}
        >
          Back to home
        </Link>
        <button
          ...
          className="border p-2 min-w-[120px] transition-all delay-100 hover:bg-brand-secondary hover:text-white hover:animate-bounce"
        >
          Print
        </button>
      </div>
      ...
      >
        <div className="flex items-center justify-center mb-2">
          <FontAwesomeIcon icon={faStar} className="text-brand-secondary text-xl" />
          <FontAwesomeIcon icon={faStar} className="text-brand-secondary text-3xl" />
          <FontAwesomeIcon icon={faStar} className="text-brand-secondary text-4xl" />
          <FontAwesomeIcon icon={faStar} className="text-brand-secondary text-3xl" />
          <FontAwesomeIcon icon={faStar} className="text-brand-secondary text-xl" />
        </div>
