      ...
      <div className="relative bg-white border shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-lg mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <button
              className={`bg-brand-secondary hover:bg-slate-100 hover:text-brand-secondary text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline w-full transition duration-300 ${
                isSubmitDisabled
