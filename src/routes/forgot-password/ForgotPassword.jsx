          ...
          {success ? (
            ...
            >
              <div className="text-center mb-10">
                <h2 className="text-3xl font-extrabold text-salte-700 my-4">
                  Reset your password
                </h2>
                <div className="mb-6">
                  <input
                ...
                <div className="flex-wrap items-center justify-between">
                  <button
                    type="submit"
                    className="w-full bg-brand-secondary hover:bg-slate-100 hover:text-brand-secondary text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                  >
                    Reset your password
                  </button>
                  <div className="mt-5">
