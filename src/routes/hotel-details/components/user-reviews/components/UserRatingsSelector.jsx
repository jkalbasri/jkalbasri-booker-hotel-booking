...
const UserRatingsSelector = ({
  ...
  return isAuthenticated ? (
    ...
    >
      ...
      />
      <button
        className="w-full bg-brand-secondary hover:bg-slate-100 px-4 py-2 text-white hover:text-brand-secondary transition duration-300 focus:outline-none focus:shadow-outline"
