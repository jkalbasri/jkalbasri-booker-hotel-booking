...
const HotelBookingDetailsCard = ({ hotelCode }) => {
  ...
  const calculatePrices = () => {
    ...
    if (!isNaN(totalPrice)) {
      setTotal(`${formatPrice(totalPrice)} DKK`);
    }
    setTaxes(`${formatPrice(totalGst)} DKK`);
  };
  ...
  return (
    <div className="mx-2 bg-white shadow-xl rounded-xl overflow-hidden mt-2 md:mt-0 w-full md:w-[380px]">
      <div className="px-6 py-4 bg-brand text-slate-600">
      ...
      <div className="p-6 text-sm md:text-base">
        ...
        <div className="mb-4">
          ...
          <div className="text-xl font-bold text-slate-600">{total}</div>
        ...
        <div className="mb-4">
          ...
          <div className="text-gray-600">
            {formatPrice(bookingDetails.currentNightRate)} DKK
          </div>
        </div>
      ...
      <div className="px-6 py-4 bg-gray-50">
        <button
          ...
          className="w-full bg-brand-secondary hover:bg-slate-100 text-white hover:text-brand-secondary py-2 transition duration-300"
        >
          Confirm Booking
        </button>
      </div>
